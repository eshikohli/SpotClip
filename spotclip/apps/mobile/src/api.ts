import type { IngestResponse, SavePlacesResponse, ExtractedPlace } from "@spotclip/shared";

const BASE_URL = __DEV__
  ? "http://10.136.51.124:3001"
  : "http://10.136.51.124:3001"; // replace with production URL
